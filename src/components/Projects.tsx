...
const projects = [
  {
    ...
    github: "https://github.com/sbm4034",
    featured: true,
    date: "December 2024",
  },
  {
    title: "ABILYTICS",
    description: "A comprehensive application featuring OTP-based authentication and a points redemption system. Built with Java for Android platform with Firebase integration.",
  ...
  {
    title: "NGOConnect",
    description: "Android application designed to connect NGOs with volunteers and donors, facilitating community engagement and support through mobile technology.",
    tech: ["Java", "Android SDK", "REST API"],
    github: "https://github.com/sbm4034/NGOConnect-android",
  },
  {
    title: "Django Sample Projects",
    description: "Collection of Django projects demonstrating best practices in Python web development, including polls application and project structure templates.",
    tech: ["Python", "Django", "SQLite", "PostgreSQL"],
